...
import { DesignFinishProducts } from '@/components/design/DesignFinishProducts';
 ...
 * back into it as the person works (`DesignAutosave`), and every floor and wall of a generated
 * design is kept the product it is shown in (`DesignFinishProducts`).
 */
