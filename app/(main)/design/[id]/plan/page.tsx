    ...
    <>
      ...
      <FlowWorkspace>
        <FlowBar
          ...
          brief={2}
          back={{ href: designStepHref(projectId, 1), label: t.calculator.backButton }}
      ...
      <StepNav className="lg:hidden" back={{ href: designStepHref(projectId, 1), label: t.calculator.backButton }} next={{ label: nextLabel, onClick: continueNext, disabled: plan.rooms.length === 0 }} />
    </>
  );
}
